...
// login route and generate Jwt token with payload userId
// in route post/blogs add middleware isLogin in this middleware verify jwt token and
//  modify req object like req.userId=decode.userId